...
print "Solid if anything goes right or up"
db $37
JMP MarioBelow : JMP return : JMP Check : JMP SpriteV : JMP SpriteH : JMP return
...
MarioFireBall:
	...
	BPL solid		;/
	LDA $173D|!addr,x		;\Also solid if going upwards.
	BMI solid		;/
	RTL
SpriteH:
