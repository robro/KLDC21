...
!include_exit = 0 ;if 0 removes the exit option from the prompt
!set_bright   = 1 ;1f 1 darkens the screen during prompt
!brightness   = 8 ;brightness to fade to if set_bright is on
!use_box	  = 0 ;if 0 don't use the message box behind the text
!reset_dsx	  = 1 ;if 1, reset the dynamic sprite slots on death

!start_select = 1 ;if 1 always allow exiting levels with start+select
!vanilla_exit = 0 ;if 1 only apply the checkpoint etc part and don't use the retry/prompt system
...
if !use_box
	...
	.tile
		...
		db $22,$21,$4A,$5A,$5A,$5A,$5A,$5A,$5A
		endif
else
	.pos_x
		db $68,$78,$88,$68,$78,$70,$80,$70,$80
	.pos_y
		db $6F,$6F,$6F,$7F,$7F,$6F,$6F,$7F,$7F
	.tile
		if !include_exit
		db $22,$21,$4A,$30,$20,$23,$22,$31,$21
		else
		db $22,$21,$4A,$5A,$5A,$23,$22,$5A,$5A
		endif
endif
.size
